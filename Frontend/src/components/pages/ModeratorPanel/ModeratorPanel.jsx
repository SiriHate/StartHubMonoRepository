...
const ModeratorPanel = () => {
    ...
    const handleApprove = async (id) => {
        try {
            let endpoint = '';
            if (activeTab === 'projects') endpoint = `${config.MAIN_SERVICE}/projects/${id}/moderation-status`;
            else if (activeTab === 'news') endpoint = `${config.MAIN_SERVICE}/news/${id}/moderation-status`;
            else if (activeTab === 'articles') endpoint = `${config.MAIN_SERVICE}/articles/${id}/moderation-status`;
