...
const PasswordChangePage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!token) { setError('Токен восстановления отсутствует или недействителен.'); return; }

        try {
            const response = await fetch(`${config.USER_SERVICE}/members/password-recoveries/${encodeURIComponent(token)}`, {
                ...
                <div className={styles.card}>
                    ...
                    <form onSubmit={handleSubmit} className={styles.form}>
                        <div className={styles.fieldGroup}>
                            ...
                            <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="Введите новый пароль" required />
                        </div>
                        <div className={styles.fieldGroup}>
