...
const LeaveFeedback = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if (!getCookie('accessToken')) { setSubmitError('Необходима авторизация'); return; }
            if (rating < 1) { setSubmitError('Выберите оценку от 1 до 5'); return; }
            setSubmitError(null);
                ...
                <div className={styles.container}>
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            >
                                {[1, 2, 3, 4, 5].map((value) => (
                                    <span
                                        ...
                                        onClick={() => { setRating(value); setSubmitError(null); }}
                        ...
                        <button type="submit" className={styles.submitBtn}>
                            <i className="fas fa-paper-plane"></i> Отправить ответы
                        </button>
                    </form>
                </div>
            </div>
